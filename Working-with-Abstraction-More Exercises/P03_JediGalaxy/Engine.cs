    ...
    public class Engine
    {
        ...
        public void Run()
        {
            ...
            while (command != "Let the Force be with you")
            {
                ...
                EvilMoveTopLeft(evilRow, evilCol);

                int playerRow = playerCoordinates[0];
                int playerCol = playerCoordinates[1];

                PlayerMoveAndCollect( playerRow, playerCol);
        ...
        private void PlayerMoveAndCollect( int playerRow,  int playerCol)
        {
        ...
        private void EvilMoveTopLeft(int evilRow,  int evilCol)
        {
